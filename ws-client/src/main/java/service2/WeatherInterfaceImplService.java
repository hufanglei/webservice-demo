 ...
 * 
 */
@WebServiceClient(name = "WeatherInterfaceImplService", targetNamespace = "http://service/", wsdlLocation = "http://127.0.0.1:54321/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERINTERFACEIMPLSERVICE_QNAME = new QName("http://service/", "WeatherInterfaceImplService");
     ...
     * 
     * @return
     *     returns WeatherInterfaceImpl1
     */
    @WebEndpoint(name = "WeatherInterfaceImplPort")
    public WeatherInterfaceImpl1 getWeatherInterfaceImplPort() {
        return super.getPort(new QName("http://service/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl1.class);
    }
     ...
     */
    @WebEndpoint(name = "WeatherInterfaceImplPort")
    public WeatherInterfaceImpl1 getWeatherInterfaceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl1.class, features);
    }
