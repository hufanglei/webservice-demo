 ...
 * 2020-05-01T12:34:57.869+08:00
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "WeatherInterfaceService",
                  wsdlLocation = "http://127.0.0.1:12345/weather?wsdl",
                  targetNamespace = "http://dao/")
public class WeatherInterfaceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://dao/", "WeatherInterfaceService");
    public final static QName WeatherInterfacePort = new QName("http://dao/", "WeatherInterfacePort");
    static {
        URL url = null;
        try {
