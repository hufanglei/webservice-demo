...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://dao/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://dao/", "queryWeatherResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dao/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dao/", name = "queryWeatherResponse")
