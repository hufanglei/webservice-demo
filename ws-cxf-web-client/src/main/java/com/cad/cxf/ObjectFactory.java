 ...
 * generated in the com.cad.cxf package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://dao.demo.example.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://dao.demo.example.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cad.cxf
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dao.demo.example.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dao.demo.example.com/", name = "queryWeatherResponse")
